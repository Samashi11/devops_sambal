...
<head>
    ...
    <title>Dark Mage - Men's Beauty</title>
                    ...
                    <div class="flex flex-col gap-10 px-4 py-10 @container">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div
                                ...
                                <div
                                    class="size-12 rounded-lg bg-[#332839] flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors text-primary">
                                    <span class="material-symbols-outlined text-[32px]">opacity</span>
                                </div>
                                <div class="flex flex-col gap-3">
                                ...
                                <a class="text-gray-500 hover:text-white transition-colors" href="#">
                                    ...
                                    <svg aria-hidden="true" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path clip-rule="evenodd"
                                            d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772 4.902 4.902 0 011.772-1.153c.636-.247 1.363-.416 2.427-.465 1.067-.047 1.407-.06 4.123-.06h.63zm-.09 1.8c-2.545 0-2.845.01-3.81.054-.968.044-1.494.205-1.846.342-.466.181-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.351-.3.879-.341 1.846-.044.965-.054 1.265-.054 3.81 0 2.545.01 2.845.054 3.81.043.966.205 1.493.341 1.846.182.466.399.8.748 1.15.35.35.683.566 1.15.748.352.137.88.3 1.846.341.965.044 1.265.054 3.81.054 2.545 0 2.845-.01 3.81-.054.968-.044 1.494-.205 1.846-.342.466-.181.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.351.3-.879.341-1.846.044-.965.054-1.265.054-3.81 0-2.545-.01-2.845-.054-3.81-.043-.966-.205-1.493-.341-1.846-.182-.466-.399-.8-.748-1.15-.35-.35-.683-.566-1.15-.748-.352-.137-.88-.3-1.846-.341-.965-.044-1.265-.054-3.81-.054zM12.315 6.87a5.13 5.13 0 110 10.26 5.13 5.13 0 010-10.26zm0 1.8a3.33 3.33 0 100 6.66 3.33 3.33 0 000-6.66zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z"
